...
sap.ui.define([
	...
	'../utils/formatter'
], function (Controller, History, Button, Dialog, BusyIndicator, formatter) {
	"use strict";

	return Controller.extend("be.flexso.ehb.Northwind-Employees.controller.BaseController", {
		...
		showBusyIndicator: function () {
			return this.busyIndicator.show();
		},

		hideBusyIndicator: function () {
			return this.busyIndicator.hide();
		},
